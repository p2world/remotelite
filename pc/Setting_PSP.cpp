...
{
	int no0,no1,no2,no3,no4,no5;
	WCHAR buff[16];

	switch ( id ){
	case 601:
		no0 = SendMessage( PSPModeLst, CB_GETCURSEL, 0, 0 );
		SettingData.PSPMode = no0;
		break;
	case 603:
		no1 = SendMessage( PSPAdr1Lst, CB_GETCURSEL, 0, 0 );
		SettingData.PSPAdr1 = no1;
		break;
	case 605:
		no2 = SendMessage( PSPAdr2Lst, CB_GETCURSEL, 0, 0 );
		SettingData.PSPAdr2 = no2;
		break;
	case 607:
		no3 = SendMessage( PSPPriLst, CB_GETCURSEL, 0, 0 );
		SettingData.PSPPri = no3;
		break;
	case 609:
		no4 = SendMessage( PSPFPSLst, CB_GETCURSEL, 0, 0 );
	...
	case 611:
		...
		break;
	case 621:
		no5 = SendMessage( PSPTrnsLst, CB_GETCURSEL, 0, 0 );
